...
public class SpecificationController {
	 ...
	 */
	@RequestMapping("/add")
	public Result add(@RequestBody SpecificationAndOption specification){
		try {
	...
	public Result update(@RequestBody SpecificationAndOption specification){
		try {
