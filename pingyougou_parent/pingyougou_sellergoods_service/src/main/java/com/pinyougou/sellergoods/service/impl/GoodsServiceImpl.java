...
import com.pinyougou.pojogroup.GoodsAndDescAndItems;
...
public class GoodsServiceImpl implements GoodsService {
	 ...
	 */
	@Override
	public void add(GoodsAndDescAndItems goodsAndDescAndItems) {
		Goods goods = goodsAndDescAndItems.getGoods();
		goodsMapper.insert(goods);
		goodsAndDescAndItems.getGoodsDesc().setGoodsId(goods.getId());
		goodsDescMapper.insert(goodsAndDescAndItems.getGoodsDesc());
